...
import com.syntech.distcomp.lab62.Main;
import com.syntech.distcomp.lab62.logic.Piece;
...
public class Graphics {
    ...
    private static boolean display(@NotNull JImGui imGui, JImTextureID image, float size, @NotNull com.syntech.distcomp.lab62.graphics.Color color, int id) {
    ...
    public static boolean display(@NotNull JImGui imGui, String name, float size, @NotNull com.syntech.distcomp.lab62.graphics.Color color, int id) {
