...
func NewGLFW(io imgui.IO, windowName string, clientAPI GLFWClientAPI) (*GLFW, error) {
	...
	window, err := glfw.CreateWindow(1280, 720, windowName + " (Running on ImGui-Go GLFW+"+string(clientAPI)+")", nil, nil)
	if err != nil {
		glfw.Terminate()
